...
describe('statements test suite', () => {
  ...
  it('outputs multiple USD rates if there are multiple this month', async () => {
    ...
    expect(response.body).toContain('Exchange rates:');
    expect(response.body).toContain('&pound;1 to &dollar;1.25 after 2017-01-01T00:00:00.000Z');
    expect(response.body).toContain('&pound;1 to &dollar;2 after 2017-01-15T00:00:00.000Z');
  });
